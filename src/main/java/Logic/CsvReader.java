...
//    }
//
//    public List<Borrowed> getListBorrowFromFile(String fileName) {
//        String filePath;
//        try {
//            filePath = CsvReader.class.getClassLoader().getResource(fileName).getPath();
//        } catch (NullPointerException e) {
...
//                records.add(line);
//            }
//            List<Borrowed> listBorrow = new ArrayList<>();
//            for (int i = 1; i < records.size(); i++) {
//                listBorrow.add(new Borrowed(records.get(i)));
//            }
//            return listBorrow;
//        } catch (IOException | CsvException e) {
...
//    }
//
//    public void appendBorrowToFile(String fileName, Borrowed borrow) {
//        String filePath = "src/main/resources/" + fileName;
//        File file = new File(filePath);
//        try {
//            FileWriter outputfile = new FileWriter(file, true);
